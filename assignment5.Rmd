...
ge_plot <- ggplot(ge_fullpred, aes(x = year, y = total_females)) +
  geom_ribbon(aes(ymin = fit.lwr_f, ymax = fit.upr_f), fill = "gray70", alpha = 0.5) +
  geom_ribbon(aes(ymin = fit.lwr_m, ymax = fit.upr_m), fill = "gray70", alpha = 0.5) +
  geom_point(color = "red") +
  geom_point(aes(x = year, y = total_males), color = "blue") + 
  geom_line(aes(x = year, y = fit.fit_f), color = "red") +
  geom_line(aes(x = year, y = fit.fit_m), color = "blue") +
  #geom_smooth(method = lm_gem1, se = T, size = 0.5, color = "gray20") +
  #geom_line(aes(x = year, y = fit.lwr_f)) +
  #geom_line(aes(x = year, y = fit.lwr_m)) +
  #geom_line(aes(x = year, y = fit.upr_f)) +
  #geom_line(aes(x = year, y = fit.upr_m)) +
  theme_bw()
